...
$(function () {
  ...
  var dt_brand_table = $('#listAdminAllWaliMuridTable');

  if (dt_brand_table.length) {
    var dt_user = dt_brand_table.DataTable({
      ajax: "/listAdminAllWaliMuridTable",
      columns: [
        { data: '' },
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Import Wali Murid</span>',
          className: 'add-new btn btn-info',
          attr: {
            'data-bs-target': '#importWaliMuridModal', 
  ...
  $(document).on('click', '#button-export-template', function () {
    location.href = '/admin/master-wali-murid/export-template';
  });
