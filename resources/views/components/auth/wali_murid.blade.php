        ...
        <div class="authentication-inner py-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="mb-1 pt-2">Selamat Datang Wali Murid!</h4>
                    <p class="mb-4">Silakan masuk ke akun Anda.</p>
                
                    <form id="formAuthentication" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('login.store', 'wali murid') }}" method="POST">
                        @csrf
